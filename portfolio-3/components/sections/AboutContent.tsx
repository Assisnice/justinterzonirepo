  ...
  return (
    <div className="space-y-6 text-slate-300">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        <img 
          src="https://picsum.photos/seed/justin-profile/200/200" // Smaller for window
          alt="Justin Terzoni" 
          className="rounded-full w-32 h-32 md:w-40 md:h-40 object-cover shadow-lg border-2 border-sky-500/50 flex-shrink-0" 
        />
